...
significance: |
  In two behavioral studies, we found that people's expectations biased their reactions to morally-significant events--people were more upset by surprising harms than more expected harms. This bias threatens to impose a pernicious cycle: People living in poverty, unstable regions, and other dangerous circumstances have the greatest need for assistance and concern from the world at-large. Yet for this very reason, it is often unsurprising when they are harmed. By blunting observers' concern for the disadvantaged, this bias could make people less likely to donate money, to volunteer, or to take political action, thereby increasing inequality and compounding suffering. Recognizing and understanding this bias will suggest ways to mitigate its harmful consequences.
